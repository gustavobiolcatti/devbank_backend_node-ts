...
exports.relationUserAccount1660600880192 = void 0;
var relationUserAccount1660600880192 = /** @class */ (function () {
    function relationUserAccount1660600880192() {
        this.name = 'relationUserAccount1660600880192';
    }
    relationUserAccount1660600880192.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"user\" ADD CONSTRAINT \"FK_68d3c22dbd95449360fdbf7a3f1\" FOREIGN KEY (\"accountId\") REFERENCES \"account\"(\"id\") ON DELETE CASCADE ON UPDATE NO ACTION")];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    relationUserAccount1660600880192.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"user\" DROP CONSTRAINT \"FK_68d3c22dbd95449360fdbf7a3f1\"")];
                    case 1:
                        _a.sent();
    ...
    return relationUserAccount1660600880192;
}());
exports.relationUserAccount1660600880192 = relationUserAccount1660600880192;
//# sourceMappingURL=1660600880192-relationUserAccount.js.map