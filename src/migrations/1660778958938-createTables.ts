...
export class createTables1660778958938 implements MigrationInterface {
    name = 'createTables1660778958938'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "account" ("accountNumber" SERIAL NOT NULL, "agency" integer NOT NULL DEFAULT '1234', "balance" integer NOT NULL DEFAULT '0', "created_At" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee66d482ebdf84a768a7da36b08" PRIMARY KEY ("accountNumber"))`);
